...
# Ensure we can import circle_area_v2.py from the same directory
THIS_DIR = Path(__file__).parent
sys.path.insert(0, str(THIS_DIR))

try:
    import circle_area_v2 as circle_area
except Exception:
    try:
        import circle_area  # fallback
